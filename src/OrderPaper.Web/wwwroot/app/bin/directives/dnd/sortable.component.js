...
var SortableContainer = (function (_super) {
    ...
    ], SortableContainer.prototype, "draggable");
    __decorate([
        core_1.Input()
    ], SortableContainer.prototype, "sortableData");
    __decorate([
        core_1.Input("dropZones")
    ], SortableContainer.prototype, "dropzones");
...
var SortableComponent = (function (_super) {
    ...
    __decorate([
        core_1.Input("dragEnabled")
    ], SortableComponent.prototype, "draggable");
    __decorate([
        core_1.Input("dropEnabled")
    ], SortableComponent.prototype, "droppable");
    __decorate([
        core_1.Input()
    ], SortableComponent.prototype, "dragData");
    __decorate([
        core_1.Input("effectAllowed")
    ], SortableComponent.prototype, "effectallowed");
    __decorate([
        core_1.Input("effectCursor")
    ], SortableComponent.prototype, "effectcursor");
    __decorate([
