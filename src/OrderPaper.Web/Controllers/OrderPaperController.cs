...
namespace OrderPapers.Controllers
{
    ...
    public class OrderPaperController : Controller
    {
        ...
        public string Get()
        {
            ...
            summary.Add(new OrderPaperWrapper { Id = 1, Number = 1, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 2, Number = 2, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 3, Number = 3, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 4, Number = 4, SittingDay = new DateTime(), Status = "Final" });
            summary.Add(new OrderPaperWrapper { Id = 5, Number = 5, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 6, Number = 6, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 7, Number = 7, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 8, Number = 8, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 9, Number = 9, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 10, Number = 10, SittingDay = new DateTime(), Status = "Provisional" });

            summary.Add(new OrderPaperWrapper { Id = 11, Number = 11, SittingDay = new DateTime(), Status = "Final" });
            summary.Add(new OrderPaperWrapper { Id = 12, Number = 12, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 13, Number = 13, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 14, Number = 14, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 15, Number = 15, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 16, Number = 16, SittingDay = new DateTime(), Status = "Final" });
            summary.Add(new OrderPaperWrapper { Id = 17, Number = 17, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 18, Number = 18, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 19, Number = 19, SittingDay = new DateTime(), Status = "Provisional" });
            summary.Add(new OrderPaperWrapper { Id = 20, Number = 20, SittingDay = new DateTime(), Status = "Final" });
        ...
        public string Get(int id)
        {
            ...
            var wrapper = new OrderPaperWrapper { Id = id, Status = "Provisional", SittingDay = new DateTime(), Number = 99 };
